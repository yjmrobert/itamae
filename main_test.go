...
var pluginAssertions = map[string]pluginAssertion{
	...
	"tldr":       {install: "sudo nala install -y tealdeer", remove: "sudo apt-get purge -y tealdeer"},
	...
	"zoxide":     {install: "curl -sS https://raw.githubusercontent.com/ajeetdsouza/zoxide/main/install.sh", remove: "sudo rm /usr/local/bin/zoxide"},
